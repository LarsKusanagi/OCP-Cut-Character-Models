= CHANGES =
To propriate with Cut Playable Status, his playable slot changes to #139. If you guys want to change to OG number where Longshot Mod first exist, go ahead, including additional textures (change or not)

= COSTUMES =
Universally uses Kazar's Upper Body & New X-Men Professor X

- Classic = Kazar (Head & Arm) + Ultimate Captain America Pocket (2) + Star Mark on right half
-- First Appearance: Longshot #1 (1985)
--- NOTE: The only costume that isn't early bird cameo, based on Contest of Champions costume style per loading screen artwork
--- BONUS: Also Include Mannequin to match his accurate loading screen, reused from Contest of Champs. Not the pose, but only costume.
- Hydra = Kazar (Head & Arm) + Ultimate Captain America Pocket (4) + Hand Mark on right half
-- First Appearance: Exiles #91 (2001)
--- NOTE: Count as Early bird Cameo. Issues released on 2007
...
Credits:
NorrinRadd: OG Mod, including Texture parts to be usable for new mesh mods
